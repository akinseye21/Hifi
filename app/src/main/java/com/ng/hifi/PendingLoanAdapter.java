...
public class PendingLoanAdapter extends BaseAdapter {
    ...
    public PendingLoanAdapter(Context context, ArrayList<String> arr_requestorName, ArrayList<String> arr_POSName, ArrayList<String> arr_POSAddress, ArrayList<String> arr_POSAmount, ArrayList<String> arr_POSImage){
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        convertView = inflter.inflate(R.layout.list_pending_loans, null);
